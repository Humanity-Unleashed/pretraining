...
from humun_econ_transformer.models import Model
from humun_econ_transformer.models.ring_attn_utils import get_ring_attn_group, set_ring_attn_group
from humun_econ_transformer.utils.distributed_sampler import DistributedSampler
...
class DeepspeedStrategy(ABC):
    ...
    def _ds_init_train_model(self, model, optim, scheduler):
        is_actor = isinstance(model, Model)
